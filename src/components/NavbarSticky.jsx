...
export default function NavbarSticky({ user, setUnloggedUser }) {
  ...
  return (
    <div>
      ...
      {/* // -m-6 max-h-[768px] w-[calc(100%+48px)] // */}
      <Navbar onClick={() => openNav ? setOpenNav(false) : null} className="fixed top-0 z-40 h-max max-w-full rounded-none px-4 py-2 md:px-8 md:py-4">
